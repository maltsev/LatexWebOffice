...
class BinaryFileTestCase(ModelTestCase):
    ...
    def test_getContent(self):
        ...
        binaryFile = BinaryFile.objects.create(
            name='readme.txt', filepath=filepath, folder=self.rootFolder_dir1)
        self.assertEqual(
            sourceCode, binaryFile.getContent().readline().decode('utf-8'))
        binaryFile.delete()
    ...
    def test_createFromFile(self):
        ...
        binaryFile = BinaryFile.objects.createFromFile(
    ...
    def test_createFromRequestFile(self):
        ...
        binaryFile = BinaryFile.objects.createFromRequestFile(
            name='icon.png', folder=self.rootFolder_dir1, requestFile=requestFileStub)
