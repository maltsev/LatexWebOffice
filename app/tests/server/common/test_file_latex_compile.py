...
class FileLatexCompileTestClass(ViewTestCase):
    ...
    def test_latexCompile(self):
        ...
        response = util.documentPoster(self, command='compile', idpara=texobj1.id, idpara3=0, idpara4=0)
        ...
        response = util.documentPoster(self, command='compile', idpara=texobj2.id, idpara3=0, idpara4=0)
        ...
        response = util.documentPoster(self, command='compile', idpara=self._invalidid, idpara3=0, idpara4=0)
        ...
        response = util.documentPoster(self, command='compile', idpara=texobj.id, idpara3=0, idpara4=0)
