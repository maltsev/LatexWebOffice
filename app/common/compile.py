...
def compile(texfile, files):
    ...
    # erzeugt ein temporäres Verzeichnis im Verzeichnis der übergebenen
    # tex-Datei
    ...
    rcode = os.system(
        str(latexmk_path()) + " -outdir=" + out_dir + " -pdf " + texfile)
    ...
    if rcode == 0:
        ...
        # TEMP
        # verschiebt die erzeugte pdf-Datei in das Verzeichnis der übergebenen
        # tex-Datei
